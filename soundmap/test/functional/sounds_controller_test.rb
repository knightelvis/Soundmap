...
class SoundsControllerTest < ActionController::TestCase
  ...
  test "should create sound" do
    assert_difference('Sound.count') do
      post :create, :sound => { :date => @sound.date, :description => @sound.description, :id => @sound.id, :location => @sound.location, :path => @sound.path, :title => @sound.title, :username => @sound.username }
    end
  ...
  test "should update sound" do
    put :update, :id => @sound, :sound => { :date => @sound.date, :description => @sound.description, :id => @sound.id, :location => @sound.location, :path => @sound.path, :title => @sound.title, :username => @sound.username }
    assert_redirected_to sound_path(assigns(:sound))
  end
