...
class SoundsControllerTest < ActionController::TestCase
  ...
  test "should create sound" do
    assert_difference('Sound.count') do
      post :create, sound: { description: @sound.description, file_path: @sound.file_path, location: @sound.location, title: @sound.title }
    end
  ...
  test "should update sound" do
    put :update, id: @sound, sound: { description: @sound.description, file_path: @sound.file_path, location: @sound.location, title: @sound.title }
    assert_redirected_to sound_path(assigns(:sound))
  end
