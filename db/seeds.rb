...
####Debug Only#####
local_filename = "/Users/qlxucn/Desktop/TMP/11.txt"
...
sound_num.times do |i|
  ...
  location = get_location(city_locations, rand(1..city_locations.length))
...
rts_num.times do |i|
  ...
  tag = Tag.find(tag_id)
  RTagSound.create(:sound_id=>sound_id, :tag_id=>tag_id, :tag_title=>tag.title)
  tag.increment
